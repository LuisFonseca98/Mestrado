...
if __name__ == "__main__":
    ...
    # remove_red_background_from_thermal_image(image_face_RGB_4, 'SavedImages/RGB_Noisy_image_face_4.png', 'SavedImages/Plot_RGB_Image_face_4.png')
    ...
    print('SNR on image_face_lena3_RGB: ', calculate_snr(image_face_lena3_RGB, image_face_lena3_brightness_RGB))
    print("")
    ...
    print('SNR on image_face_lena4_RGB: ', calculate_snr(image_face_lena4, image_face_lena4_RGB))
    print("")
    ...
    # print(calculate_mae_mse_rgb_images(image_monarch1, image_monarch1_enhanced))
    # print('SNR on image_monarch1_RGB: ', calculate_snr(image_monarch1, image_monarch1_enhanced))
    # print("")
    #
    ...
    # print(calculate_mae_mse_rgb_images(image_monarch2, image_monarch2_enhanced))
    # print('SNR on image_monarch2_RGB: ', calculate_snr(image_monarch2, image_monarch2_enhanced))
    # print("")
    #
    # image_monarch3 = cv2.imread('Dataset/RGBNoisyImages/monarch3.png',cv2.COLOR_BGR2RGB)
    # remove_blur_and_enhance_contrast(image_monarch3, 'SavedImages/Monarch3_enhanced.png', 'SavedImages/Plot_GB_monarch_3_RGB.png')
    # image_monarch3_enhanced = cv2.imread('SavedImages/Monarch3_enhanced.png')
    # print(calculate_mae_mse_rgb_images(image_monarch3, image_monarch3_enhanced))
    # print('SNR on image_monarch3_RGB: ', calculate_snr(image_monarch3, image_monarch3_enhanced))
    # print("")
    #
    ...
    # print(calculate_mae_mse_rgb_images(image_monarch4, image_monarch4_enhanced))
    # print('SNR on image_monarch4_RGB: ', calculate_snr(image_monarch4, image_monarch4_enhanced))
    # print("")
