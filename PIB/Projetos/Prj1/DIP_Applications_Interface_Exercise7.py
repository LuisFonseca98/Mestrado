...
if __name__ == "__main__":
    ...
    buttons.append(
        tk.Button(buttonFrame, text="Capture image from camera", font=fontStyle, command=capturePictureFromCamera))
    ...
    buttons.append(tk.Button(buttonFrame, text="JPEG Lossy Compression", font=fontStyle,
                             command=showShowSavePictureJPEGCompression))
